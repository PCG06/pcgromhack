...
#define ITEM_TWISTEDSPOON          TEM_TWISTED_SPOON // Pre-Gen VI name
#define ITEM_SILVER_POWDER         436
#define ITEM_SILVERPOWDER          TEM_SILVER_POWDER // Pre-Gen VI name
...
#define ITEM_BRIGHTPOWDER          TEM_BRIGHT_POWDER // Pre-Gen VI name
